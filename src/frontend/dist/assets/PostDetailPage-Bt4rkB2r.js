import { e as createLucideIcon, r as reactExports, j as jsxRuntimeExports, d as cn, h as useParams, a as useNavigate, u as useAuth, b as useQueryClient, B as Button, H as Heart, M as MessageCircle, L as LoadingSpinner, c as ue } from "./index-D3K2DxjU.js";
import { u as useBackend, a as useQuery, b as useMutation, A as Avatar } from "./useBackend-DvPbmnhr.js";
import { a as formatCount, E as EmptyState, S as Send, f as formatDate } from "./format-BPzIRd4_.js";
import { L as Layout } from "./index-DkjgesTa.js";
import { P as Primitive } from "./index-Cy7DJa27.js";
import { T as Textarea, u as useFileUpload, E as Ellipsis } from "./useFileUpload-3xYnKDhh.js";
import { A as ArrowLeft } from "./arrow-left-ClfLvTsP.js";
import { X } from "./x-B4ixtO6V.js";
import { I as Image } from "./image-BVtHCERd.js";
/**
...
const FileQuestion = createLucideIcon("file-question", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function PostDetailPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { onWalletOpen: () => navigate({ to: "/wallet" }), children: [
    ...
    ) : !postLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        icon: FileQuestion,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 pb-32", "data-ocid": "post-detail-comments-list", children: commentsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "md" }) }) : comments && comments.length > 0 ? comments.map((comment) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      CommentRow,
      {
        comment,
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-10 h-10 text-muted-foreground/30 mb-3" }),
